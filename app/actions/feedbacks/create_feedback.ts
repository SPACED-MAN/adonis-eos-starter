...
export default class CreateFeedback {
	static async handle({ postId, userId, mode, content, type, context }: CreateFeedbackParams): Promise<Feedback> {
		...
		// 2. Trigger Workflows
		await workflowExecutionService.executeWorkflows('feedback.created', {
