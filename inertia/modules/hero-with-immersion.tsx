      ...
      <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full h-full py-12 lg:py-20 flex items-center">
          <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
            ...
            >
              <Title
                className="text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-black text-on-standout tracking-tighter drop-shadow-[0_10px_10px_rgba(0,0,0,0.5)] leading-[0.9]"
              ...
              {subtitle && (
                <Subtitle
                  className="text-xl md:text-2xl lg:text-3xl text-on-standout/90 font-medium max-w-2xl drop-shadow-md"
