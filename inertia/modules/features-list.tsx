					...
					<div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-8 md:space-y-0">
						{safeFeatures.map((feature, idx) => (
							...
							>
								...
								<h3 className="mb-2 text-lg sm:text-xl font-semibold text-neutral-high" data-inline-path={`features.${idx}.title`}>
									{feature.title}
								</h3>
								<p className="text-sm sm:text-base text-neutral-medium" data-inline-path={`features.${idx}.body`}>
									{feature.body}
								</p>
							</div>
						))}
