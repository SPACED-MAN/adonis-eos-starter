                      ...
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          {isAggregateDirty(postType) && (
                            <button
                              type="button"
                              className="px-3 py-1 text-xs font-semibold rounded bg-standout-high text-on-high disabled:opacity-50 transition-all hover:opacity-90"
                          ...
                          return (
                            <div key={key} className="flex items-center gap-3">
                              ...
                              {isPatternDirty(postType, loc) && (
                                <button
                                  type="button"
                                  className="px-4 py-2 text-sm font-semibold rounded bg-standout-high text-on-high disabled:opacity-50 min-w-[100px] transition-all hover:opacity-90"
